...
$nouBitllet = new Bitllet($_SESSION["idBitllet"],$origen,$destinacio,$preuBitllet,$_SESSION["objUser"]->getUser(),$_SESSION["anadaTornadaBool"], $_SESSION["dataAnada"], $_SESSION["dataTornada"]);
